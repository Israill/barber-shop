...
const About = () => {
  ...
  const reviews = [
    {
      text: "Очень приятно рекомендовать. Стригусь здесь не первый год. Удобная локация в центре. Культурно, атмосферно, спокойный и вежливый персонал. Приятная эстетика. Но хожу сюда не за этим. Причина - опыт, мастерство и художественный вкус мастера Эдуарда. Благодаря Эдуарду - порядок не только в голове, но и на голове",
      name: "Магомед М.",
    },
    {
      text: "Отличное место, очень уютно, всегда отлично постригут, поддержат беседу и рады вам в любую погоду. Отдельно хочу поблагодарить Мастера с большой буквы - Эдуарда Шаипова",
      name: "Ахмед К.",
    },
    {
      text: "Очень уютный барбершоп с кайфовым расположением. Залетать туда на стригу всегда одно удовольствие. Особенно когда на смене Эдик. Топовый барбер с руками скульптора. Ещё и лекцию по укладочным средствам проведёт в процессе стрижки.",
      name: "Дмитрий Б.",
    },
    {
      text: "Крайне редко оставляю отзывы о чем бы то ни было. Стригусь уже много лет в подобных заведениях, доводилось бывать в разных филиалах и в разных барбершопах, поэтому сравнить есть с чем. Все на высшем уровне!",
      name: "Александр Х.",
    },
  ];
          ...
          return (
            <SwiperSlide key={index}>
                    <div className="main d-flex flex-column justify-content-between">
                      <p className="main_review !w-full h-full">
                        {i.text}
                      </p>
                      <span className="main_author highlight">{i.name}</span>
                    </div>
                    </SwiperSlide>
          );
        })}
            ...
            <div className="reviews_controls d-flex align-items-center">
              <span className="reviews_controls-control reviews_controls-control--prev">
                <i id="arrow_left" className="icon-arrow_left"></i>
              </span>
              <span className="reviews_controls-control reviews_controls-control--next">
                <i id="arrow_right" className="icon-arrow_right"></i>
              </span>
            </div>
          </div>
        </section>
